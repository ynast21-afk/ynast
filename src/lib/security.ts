...
const RATE_LIMIT_CONFIG = {
    ...
    maxRequests: 60,            // 60 requests per minute for general
    maxWriteRequests: 15,       // 15 write operations per minute
    blockDurationMs: 5 * 60 * 1000, // Block for 5 minutes after limit hit
}
